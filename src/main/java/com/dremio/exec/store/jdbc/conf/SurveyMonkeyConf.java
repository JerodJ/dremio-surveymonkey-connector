...
@SourceType(value = "SurveyMonkeyARP", label = "SurveyMonkey",uiConfig = "surveymonkey-layout.json")
public class SurveyMonkeyConf extends AbstractArpConf<SurveyMonkeyConf> {
  private static final String ARP_FILENAME = "arp/implementation/surveymonkey-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.surveymonkey.SurveyMonkeyDriver";
